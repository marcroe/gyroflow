...
class BlackboxExtractor:
    ...
    def get_gyro_data(self,cam_angle_degrees=0, bbField="gyroADC"):
        ...
        for lg in range(1,self.n_of_logs+1):
            ...
            gx = self.parser.field_names.index(bbField+'[1]')
            gy = self.parser.field_names.index(bbField+'[2]')
            gz = self.parser.field_names.index(bbField+'[0]')
            data_frames = []
